"""
SVM (LinearSVC) Classifier for KDD Network Intrusion Detection
===============================================================
OVERFITTING FIXES APPLIED:
  ...
  4. Replaced SelectKBest(chi2) with SelectKBest(f_classif) —
     chi2 requires non-negative values and is less stable with scaled data
  5. Wrapped LinearSVC in CalibratedClassifierCV to get probabilities
     and threshold flexibility
  6. Evaluation on BOTH KDDTest+ and KDDTest-21

NOTE: SVM naturally generalises better than tree models because it
      maximises the margin — less likely to memorise noise.
"""
...
K_FEATURES = 35   # keep top-35 features (from 30 numeric + OHE-expanded cats)
...
print("="*65)
print("  SVM (LinearSVC) — REGULARISED (OVERFITTING FIXED)")
print("="*65)
...
# LinearSVC — inherently linear, strong regularisation via C
